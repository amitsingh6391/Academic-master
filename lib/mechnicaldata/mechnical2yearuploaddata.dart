...
class Mechnical2yearuplod extends StatefulWidget {
  @override
  _Mechnical2yearuplodState createState() => _Mechnical2yearuplodState();
}

class _Mechnical2yearuplodState extends State<Mechnical2yearuplod> {
  ...
  uploadBlog() async {
    if (selectedIcon != null && selectedImage != null) {
      ...
      Map<String, dynamic> mechnical2yearMap = {
        "imgUrl": downloadUrl,
      ...
      crudMethods.addmechnical2yearData(mechnical2yearMap).then((result) {
        Navigator.push(
            context,
            MaterialPageRoute(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          "Upload mechnical 2 year contents",
          style: TextStyle(
