...
import "ece3yearuploaddata.dart";
Color x = Colors.white;
Color textcolor = Colors.black;

class Ece3yearPage extends StatefulWidget {
  @override
  _Ece3yearPageState createState() => _Ece3yearPageState();
}

class _Ece3yearPageState extends State<Ece3yearPage> {
  ...
  @override
  void initState() {
    crudMethods.getece3yearData().then((result) {
      setState(() {
        blogsStream = result;
      });
    });
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => Ece3yearuplod()));
        },
      ),
      appBar: AppBar(
        backgroundColor: Color(0xFF0000A0),
        title: Text(
          "Explore Ece 3 year Contents",
          style: TextStyle(
