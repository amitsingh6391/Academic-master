...
import "ece3yearfetchdata.dart";



class Ece3yearuplod extends StatefulWidget {
  @override
  _Ece3yearuplodState createState() => _Ece3yearuplodState();
}

class _Ece3yearuplodState extends State<Ece3yearuplod> {
  ...
  uploadBlog() async {
    if (selectedIcon != null && selectedImage != null) {
      ...
      Map<String, dynamic> ece3yearMap = {
        "imgUrl": downloadUrl,
      ...
      crudMethods.addece3yearData(ece3yearMap).then((result) {
        Navigator.push(
            context,
            MaterialPageRoute(
