...
class Bpharma extends StatefulWidget {
  @override
  _BpharmaState createState() => _BpharmaState();
}

class _BpharmaState extends State<Bpharma> {
...
// on failure do
  ...
  addMessage() {
    if (messageEditingController.text.isNotEmpty) {
      ...
      DatabaseMethods().addbpharmaMessage(chatMessageMap);
  ...
  @override
  void initState() {
    DatabaseMethods().chats("bpharmachat").then((val) {
      setState(() {
        chats = val;
      });
    });
                  ...
                  children: [
                    ...
                    Row(children: [
                      ...
                      Column(children: [
                        ...
                        Text(
                          "(Desc: This group for B.Pharma,don't send any spam )",
                          style: TextStyle(
