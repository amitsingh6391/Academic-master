...
class Dpharmachat extends StatefulWidget {
  @override
  _DpharmachatState createState() => _DpharmachatState();
}

class _DpharmachatState extends State<Dpharmachat> {
  ...
  Future<void> sendNotification(subject, title) async {
    ...
    String toParams = "/topics/" + 'bpharma';
...
// on failure do
  ...
  addMessage() {
    if (messageEditingController.text.isNotEmpty) {
      ...
      DatabaseMethods().adddpharmaMessage(chatMessageMap);
  ...
  @override
  void initState() {
    DatabaseMethods().chats("dpharmachat").then((val) {
      setState(() {
        chats = val;
      });
    });
                  ...
                  children: [
                    ...
                    Row(children: [
                      ...
                      Column(children: [
                        ...
                        Text(
                          "(Desc: This group for D.pharma, don't send any spam )",
                          style: TextStyle(
                  ...
                  child: Row(
                    children: <Widget>[
                      ...
                      GestureDetector(
                        onTap: () {
                          addMessage();
                          _firebaseMessaging.subscribeToTopic("bpharma");
