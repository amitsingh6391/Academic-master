...
//import "notesandquantum/Bscfirstyearsubject.dart";
      ...
      child: Container(
                  ...
                  children: <Widget>[
                    ...
                    FlatButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(context,MaterialPageRoute(builder: (context)=>Bsc1yearsubject(),));
                      },
                    ),
                  ],
                ),
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    FlatButton(
                      ...
                      onPressed: () {
                       Navigator.push(context,MaterialPageRoute(builder: (context)=>Bsc1yearpaper(),));
                      // launchurl();
                      },
                    ),
                  ],
        ...
        children: <Widget>[
          ...
          FlatButton(
            ...
            onPressed: (){
              Navigator.push(context, MaterialPageRoute(builder: (context)=>Videotutorials(collection:"Bscfirstyearvideo"),));
            },
          ),
        ],
                ),
