      ...
      child: Container(
                  ...
                  children: <Widget>[
                    ...
                    FlatButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(context,MaterialPageRoute(builder: (context)=>Bsc4yearsubject(),));
                      },
                    ),
                  ],
                ),
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    FlatButton(
                      ...
                      onPressed: () {
                        Navigator.push(context,MaterialPageRoute(builder: (context)=>Bsc4yearpaper(),));
        ...
        children: <Widget>[
          ...
          FlatButton(
            ...
            onPressed: (){
              Navigator.push(context, MaterialPageRoute(builder: (context)=>Videotutorials(collection:"Bscfourthyearvideo"),));
            },
          ),
        ],
                ),
