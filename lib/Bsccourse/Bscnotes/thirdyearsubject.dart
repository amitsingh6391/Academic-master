...
class Bsc3yearsubject extends StatefulWidget {
  @override
  _Bsc3yearsubjectState createState() => _Bsc3yearsubjectState();
}

class _Bsc3yearsubjectState extends State<Bsc3yearsubject> {
...
class Bsc3yearpaper extends StatefulWidget {
  @override
  _Bsc3yearpaperState createState() => _Bsc3yearpaperState();
}

class _Bsc3yearpaperState extends State<Bsc3yearpaper> {
  final ams = AdMobService(); //call admobclass from services
