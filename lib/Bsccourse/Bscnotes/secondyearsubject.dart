...
class Bsc2yearsubject extends StatefulWidget {
  @override
  _Bsc2yearsubjectState createState() => _Bsc2yearsubjectState();
}

class _Bsc2yearsubjectState extends State<Bsc2yearsubject> {
...
class Bsc2yearpaper extends StatefulWidget {
  @override
  _Bsc2yearpaperState createState() => _Bsc2yearpaperState();
}

class _Bsc2yearpaperState extends State<Bsc2yearpaper> {
  final ams = AdMobService(); //call admobclass from services
