...
//import "notesandquantum/Bpharma3yearsubject.dart";
      ...
      child: Container(
                  ...
                  children: <Widget>[
                    ...
                    FlatButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(context,MaterialPageRoute(builder: (context)=>Bpharm3yearsubject(),));
                      },
                    ),
                  ],
                ),
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    FlatButton(
                      ...
                      onPressed: () {
                       Navigator.push(context,MaterialPageRoute(builder: (context)=>Bpharm3yearpaper(),));
                      // launchurl();
                      },
                    ),
                  ],
        ...
        children: <Widget>[
          ...
          FlatButton(
            ...
            onPressed: (){
              Navigator.push(context, MaterialPageRoute(builder: (context)=>Videotutorials(collection:"Bpharma3yearvideo"),));
            },
          ),
        ],
                ),
