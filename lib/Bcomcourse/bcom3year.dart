      ...
      child: Container(
          ...
          height: 20,
            ...
            Expanded(
              ...
              child: Container(
                ...
                color: Colors.white,
                child:Image.asset("images/bcom3.png",)
      )
            ),
                  ...
                  children: <Widget>[
                    ...
                    FlatButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(context,MaterialPageRoute(builder: (context)=>Bcom3yearsubject(),));
                      },
                    ),
                  ],
                ),
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    FlatButton(
                      ...
                      onPressed: () {
                       Navigator.push(context,MaterialPageRoute(builder: (context)=>Bcom3yearpaper(),));
                      // launchurl();
                      },
                    ),
                  ],
        ...
        children: <Widget>[
          ...
          FlatButton(
            ...
            onPressed: (){
              Navigator.push(context, MaterialPageRoute(builder: (context)=>Videotutorials(collection:"Bcom3yearvideo"),));
            },
          ),
        ],
                ),
