...
import 'package:Academicmaster/civildata/civil2yearuploaddata.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        tooltip: "upload a new civil contents",
        backgroundColor: Colors.green,
        child: Icon(Icons.add),
        onPressed: () {
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => CivilSecondyearuplod()));
        },
      ),
      appBar: AppBar(
